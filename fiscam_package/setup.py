...
def move_build_artifcats(target_dir, base_dir):
    ...
    # Find .egg-info dir
    egg_info_dirs = glob.glob(os.path.join(base_dir, 'fiscam_*.egg-info')) # This generates in base dir for some reason #TODO: Fix for quality of life but not needed for functionality
...
# Setup package
package_name = f'fiscam-{timeNow}'
setup(
    name=package_name,
    version='1.0.1',
    author='FISCAM_AUTOMATION',
    ...
    description='fiscam main branch',
    url='https://github.com/dod-advana/fiscam-automation',
    classifiers=[
